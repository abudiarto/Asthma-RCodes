...
selectedPatients<-fclinical_selected_2016_2018 %>%
  ...
  filter(row_number()==1)%>%
  select(patid)
save(selectedPatients,file='../FinalData/selectedPatients_13Oct2020.Rdata')
```
...
data_folder='../ServerData_10102024'


## download f_clinical

foreach (kc = 74:num_files, .packages=c('tictoc', 'dplyr', 'RODBC'), .verbose = TRUE)%dopar%{
  tic()
  dw <- config::get()
  con <- odbcConnect("opcrd_dsn", uid=dw$uid, pwd=dw$pwd)
  ...
  myquery=paste("SELECT * FROM [OPC_Client_Research].[dbo].[f_clinical] WHERE (event_date < '2019-1-1') AND (event_date >= '2016-1-1') AND patid IN ('", paste(patients_subset,collapse='\',\''),"')",sep='')
...
foreach (kc = 1:num_files, .packages=c('tictoc', 'dplyr', 'RODBC'), .verbose = TRUE)%dopar%{
  ...
  iB=min(num_patients,(kc*chunk_size))
  patients_subset=selectedPatients$patid[iA:iB]
  myquery=paste("SELECT * FROM [OPC_Client_Research].[dbo].[f_therapy] WHERE (event_date < '2019-1-1') AND (event_date >= '2016-1-1')AND patid IN ('", paste(patients_subset,collapse='\',\''),"')",sep='')
...
foreach (kc = 1:num_files, .packages=c('tictoc', 'dplyr', 'RODBC'), .verbose = TRUE)%dopar%{
  ...
  iB=min(num_patients,(kc*chunk_size))
  patients_subset=selectedPatients$patid[iA:iB]
  myquery=paste("SELECT * FROM [OPC_Client_Research].[dbo].[f_referral] WHERE (event_date < '2019-1-1') AND (event_date >= '2016-1-1') AND patid IN ('", paste(patients_subset,collapse='\',\''),"')",sep='')
...
ONS_PostCodes=read.csv('../FinalData/National_Statistics_Postcode_Lookup_UK.csv')
...
foreach (kc = 1:num_files, .packages=c('tictoc', 'tidyverse'), .verbose = TRUE)%dopar%{
  ...
  save(feature_sex_age,file=paste('../PrepareDataNew_20162018/',data_save_folder,'/feature_sex_age_',kc,'.Rdata',sep=''))
}
```
...
foreach (kc = 1:num_files, .packages=c('tictoc', 'tidyverse'))%dopar%{
  ...
  process_Weight<-f_clinical_part%>%
    group_by(patid)%>%
    filter((event_date)<ymd('2018/1/1'))%>%
    filter(code_id=='22A..')%>%
  ...
  save(feature_BMI,file=paste('../PrepareDataNew_20162018/',data_save_folder,'/feature_BMI_',kc,'.Rdata',sep=''))
}
```

# Feature 3: BMI without height and weight
```{r}
rm(list=ls())
source('./ParallelCode.R')
library(tidyverse)
...
foreach (kc = 1:num_files, .packages=c('tictoc', 'tidyverse'))%dopar%{
  ...
  # get the latest BMI value of the patient
  process_Weight<-f_clinical_part%>%
    group_by(patid)%>%
    filter((event_date)<ymd('2018/1/1'))%>%
    filter(code_id=='22A..')%>%
  ...
  process_Height<-f_clinical_part%>%
    ...
    arrange(desc(event_date),.by_group=TRUE)%>%
    filter(row_number()==1)%>%
    mutate(height=numeric_1)
  
  feature_BMI<-f_clinical_part%>%
    group_by(patid)%>%
    filter((event_date)<ymd('2018/1/1'))%>%
    filter(code_id=='22K..')%>%
    arrange(desc(event_date),.by_group=TRUE)%>%
    filter(row_number()==1)%>%
    mutate(BMI=numeric_1) %>% 
    select(patid,BMI)
  
  
  save(feature_BMI,file=paste('../PrepareDataNew_20162018/',data_save_folder,'/feature_BMINew_',kc,'.Rdata',sep=''))
}
```
...
# for (kc in c(1:num_files)){
  ...
  save(feature_Ethnicity,file=paste('../PrepareDataNew_20162018/',data_save_folder,'/feature_Ethnicity_',kc,'.Rdata',sep=''))
}
```
...
foreach (kc = 1:num_files, .packages=c('tictoc', 'tidyverse', 'lubridate'))%dopar%{
  ...
  save(feature_Smoking,file=paste('../PrepareDataNew_20162018/',data_save_folder,'/feature_Smoking_',kc,'.Rdata',sep=''))
}
```
...
foreach (kc = 1:num_files, .packages=c('tictoc', 'tidyverse', 'lubridate'))%dopar%{
  ...
  save(feature_CharlsonScore,file=paste('../PrepareDataNew_20162018/',data_save_folder,'/feature_CharlsonScore_',kc,'.Rdata',sep=''))
}
```
...
foreach (kc = 1:num_files, .packages=c('tictoc', 'tidyverse', 'lubridate'))%dopar%{
  ...
  save(feature_PEF,file=paste('../PrepareDataNew_20162018/',data_save_folder,'/feature_PEF_',kc,'.Rdata',sep=''))
}
```
...
foreach (kc = 1:num_files, .packages=c('tictoc', 'tidyverse', 'lubridate'))%dopar%{
  ...
  save(feature_Eosinophil,file=paste('../PrepareDataNew_20162018/',data_save_folder,'/feature_Eosinophil_',kc,'.Rdata',sep=''))
}
```
...
foreach (kc = 1:num_files, .packages=c('tictoc', 'tidyverse', 'lubridate'))%dopar%{
  ...
  feature_OCS<-f_therapy_part%>%
    ...
    select(patid,numOCS)
   rm(f_therapy_part)
   save(feature_OCS,file=paste('../PrepareDataNew_20162018/',data_save_folder,'/feature_OCS_',kc,'.Rdata',sep=''))
}
```
...
foreach (kc = 1:num_files, .packages=c('tictoc', 'tidyverse', 'lubridate'))%dopar%{
  ...
  feature_priorAsthmaEducation<-f_clinical_part%>%
   ...
   rm(f_clinical_part)
   save(feature_priorAsthmaEducation,file=paste('../PrepareDataNew_20162018/',data_save_folder,'/feature_priorAsthmaEducation',kc,'.Rdata',sep=''))
}
```

# Feature 18b: Prior Asthma Management Plan
```{r}
rm(list=ls())
source('./ParallelCode.R')
library(tidyverse)
library(lubridate)
data_load_folder='../ServerData_10102024'
data_save_folder='PriorAsthmaManagement'
load('../FinalData/selectedPatients_13Oct2020.Rdata')
PriorAsthmaManagementCodes=c("663U.", "661M1", "661N1", "663U.", "66Y5.", "66Y9.", "66YA.")
...
foreach (kc = 1:num_files, .packages=c('tictoc', 'tidyverse', 'lubridate'))%dopar%{
  ...
  feature_priorAsthmaManagement<-f_clinical_part%>%
    group_by(patid)%>%
    filter((event_date)<ymd('2018/1/1') & (event_date)>ymd('2015/12/31'))%>%
    filter (code_id %in% PriorAsthmaManagementCodes) %>% 
    mutate(numAsthmaManagement=length(unique(event_date))) %>% 
    select(patid,numAsthmaManagement)
  
   rm(f_clinical_part)
   save(feature_priorAsthmaManagement,file=paste('../PrepareDataNew_20162018/',data_save_folder,'/feature_priorAsthmaManagement',kc,'.Rdata',sep=''))
}
```

# Feature 18c: Prior Asthma Review
```{r}
rm(list=ls())
source('./ParallelCode.R')
library(tidyverse)
...
# Feature 18d: Prior Asthma med Review
```{r}
rm(list=ls())
source('./ParallelCode.R')
library(tidyverse)
...
# Feature 18e: Prior Asthma Review RCP
```{r}
rm(list=ls())
source('./ParallelCode.R')
library(tidyverse)
library(lubridate)
data_load_folder='../ServerData_10102024'
data_save_folder='PriorAsthmaReviewRCP'
load('../FinalData/selectedPatients_13Oct2020.Rdata')
AsthmaAnnualReviewCodes=c("66YJ.")
AsthmaMedicalReview = c("8B3j.")
AsthmaReviewRCP = c("66Yp.")
...
foreach (kc = 1:num_files, .packages=c('tictoc', 'tidyverse', 'lubridate'))%dopar%{
  ...
  feature_priorAsthmaReviewRCP<-f_clinical_part%>%
    group_by(patid)%>%
    filter((event_date)<ymd('2018/1/1') & (event_date)>ymd('2015/12/31'))%>%
    filter (code_id %in% AsthmaReviewRCP) %>% 
    mutate(numAsthmaReviewRCP=length(unique(event_date))) %>% 
    select(patid,numAsthmaReviewRCP)
  
   rm(f_clinical_part)
   save(feature_priorAsthmaReviewRCP,file=paste('../PrepareDataNew_20162018/',data_save_folder,'/feature_priorAsthmaReviewRCP',kc,'.Rdata',sep=''))
}
```
...
foreach (kc = 1:num_files, .packages=c('tictoc', 'tidyverse', 'lubridate'))%dopar%{
  ...
  feature_primarycare<-f_clinical_part%>%
    ...
    select(patid,numPCS)
   rm(f_clinical_part)
   save(feature_primarycare,file=paste('../PrepareDataNew_20162018/',data_save_folder,'/feature_primarycare',kc,'.Rdata',sep=''))
}
```
...
foreach (kc = 1:num_files, .packages=c('tictoc', 'tidyverse', 'lubridate'))%dopar%{
  ...
  feature_primarycareasthma<-f_clinical_part%>%
   ...
   rm(f_clinical_part)
   save(feature_primarycareasthma,file=paste('../PrepareDataNew_20162018/',data_save_folder,'/feature_primarycareasthma',kc,'.Rdata',sep=''))
}
```
...
foreach (kc = 1:num_files, .packages=c('tictoc', 'tidyverse', 'lubridate', 'mltools', 'data.table'))%dopar%{
 ...
 ## for the remaining features, we should get a flag next to OCS, Antibiotics, and Other Hospitalization to confirm if they are present when there 
  ...
  feature_asthmaAttacks_month <- as_tibble(one_hot(as.data.table(feature_asthmaAttacks_month)))
    ...
    #Feature 21
  save(feature_numAntibiotics,file=paste('../PrepareDataNew_20162018/',data_save_folder,'/feature_numAntibiotics_',kc,'.Rdata',sep=''))
    #Feature 22
  save(feature_acuteRespEvents,file=paste('../PrepareDataNew_20162018/',data_save_folder,'/feature_acuteRespEvents_',kc,'.Rdata',sep=''))
    #Feature 23
  save(feature_numOCS,file=paste('../PrepareDataNew_20162018/',data_save_folder,'/feature_numOCS_',kc,'.Rdata',sep=''))
    #Feature 24
  save(feature_numOCSwithLRTI,file=paste('../PrepareDataNew_20162018/',data_save_folder,'/feature_numOCSwithLRTI_',kc,'.Rdata',sep=''))
    #Feature 25
  save(feature_numAntibioticswithLRTI,file=paste('../PrepareDataNew_20162018/',data_save_folder,'/feature_numAntibioticswithLRTI_',kc,'.Rdata',sep=''))
    #Feature 26
  save(feature_numHospitals,file=paste('../PrepareDataNew_20162018/',data_save_folder,'/feature_numHospitals_',kc,'.Rdata',sep=''))
  #Feature 27
  save(feature_asthmaAttacks,file=paste('../PrepareDataNew_20162018/',data_save_folder,'/feature_asthmaAttacks_',kc,'.Rdata',sep=''))
  #Feature 27_extended
save(feature_asthmaAttacks_month,file=paste('../PrepareDataNew_20162018/',data_save_folder,'/feature_asthmaAttacksMonth_',kc,'.Rdata',sep=''))
}
```
...
# for (kc in c(1:1)){
  ...
  save(feature_comorbid,file=paste('../PrepareDataNew_20162018/',data_save_folder,'/feature_comorbid_',kc,'.Rdata',sep=''))
...
# for (kc in c(1:1)){
  ...
  save(feature_comedication,file=paste('../PrepareDataNew_20162018/',data_save_folder,'/feature_comedication_',kc,'.Rdata',sep=''))
...
# outcome 1 : exacerbation attack in 3 months (1st January 2018-31st March 2018)
```{r}
rm(list=ls())
library(tidyverse)
library(lubridate)
...
foreach (kc = 1:num_files, .packages=c('tictoc', 'tidyverse', 'lubridate'))%dopar%{
 ...
 # get id of all patients
  ...
  save(asthmaAttacks_3months,file=paste('../PrepareDataNew_20162018/',data_save_folder,'/asthmaAttacks_3months_',kc,'.Rdata',sep=''))
}
toc()
```

# outcome 2 : exacerbation attack in 6 months (01st April 2018 -30th June 2018)
```{r}
rm(list=ls())
library(tidyverse)
library(lubridate)
...
foreach (kc = 1:num_files, .packages=c('tictoc', 'tidyverse', 'lubridate'))%dopar%{
 ...
 # get id of all patients
  ...
  save(asthmaAttacks_6months,file=paste('../PrepareDataNew_20162018/',data_save_folder,'/asthmaAttacks_6months_',kc,'.Rdata',sep=''))
}
```

# outcome 3 : exacerbation attack in 9 months (1st July 2018- 30th Sep 2018)
```{r}
rm(list=ls())
library(tidyverse)
library(lubridate)
...
foreach (kc = 1:num_files, .packages=c('tictoc', 'tidyverse', 'lubridate'))%dopar%{
 ...
 # get id of all patients
  ...
  save(asthmaAttacks_9months,file=paste('../PrepareDataNew_20162018/',data_save_folder,'/asthmaAttacks_9months_',kc,'.Rdata',sep=''))
}
```

# outcome 4 : exacerbation attack in 12 months (1st October 2018-31st Dec 2018)
```{r}
rm(list=ls())
library(tidyverse)
library(lubridate)
...
foreach (kc = 1:num_files, .packages=c('tictoc', 'tidyverse', 'lubridate'))%dopar%{
 ...
 # get id of all patients
  ...
  save(asthmaAttacks_12months,file=paste('../PrepareDataNew_20162018/',data_save_folder,'/asthmaAttacks_12months_',kc,'.Rdata',sep=''))
}
```


# outcome 4 : exacerbation attack in 12 months - experiment on excluding medications
```{r}
rm(list=ls())
source('./ParallelCode.R')
library(tidyverse)
library(lubridate)
data_load_folder='../ServerData_10102024'
data_save_folder='Outcome_12months_experiment'
load('../FinalData/selectedPatients_13Oct2020.Rdata')
...
resp_review_file = read.csv('./ClinicalCodes/cl_lower_resp_events.txt')
resp_review_codes=resp_review_file$read_code
oral_ocs_codes <- c("xxx") #-> to exclude medication

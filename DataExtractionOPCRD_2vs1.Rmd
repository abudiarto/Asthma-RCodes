...
foreach (kc = 1:num_files, .packages=c('tictoc', 'tidyverse'), .verbose = TRUE)%dopar%{
  ...
  save(feature_sex_age,file=paste('../PrepareDataNew/',data_save_folder,'/feature_sex_age_',kc,'.Rdata',sep=''))
}
```
...
foreach (kc = 1:num_files, .packages=c('tictoc', 'tidyverse'))%dopar%{
  ...
  save(feature_BMI,file=paste('../PrepareDataNew/',data_save_folder,'/feature_BMI_',kc,'.Rdata',sep=''))
}
```
...
# for (kc in c(1:num_files)){
  ...
  save(feature_Ethnicity,file=paste('../PrepareDataNew/',data_save_folder,'/feature_Ethnicity_',kc,'.Rdata',sep=''))
}
```
...
foreach (kc = 1:num_files, .packages=c('tictoc', 'tidyverse', 'lubridate'))%dopar%{
  ...
  save(feature_Smoking,file=paste('../PrepareDataNew/',data_save_folder,'/feature_Smoking_',kc,'.Rdata',sep=''))
}
```
...
foreach (kc = 1:num_files, .packages=c('tictoc', 'tidyverse', 'lubridate'))%dopar%{
  ...
  save(feature_CharlsonScore,file=paste('../PrepareDataNew/',data_save_folder,'/feature_CharlsonScore_',kc,'.Rdata',sep=''))
}
```
...
foreach (kc = 1:num_files, .packages=c('tictoc', 'tidyverse', 'lubridate'))%dopar%{
  ...
  save(feature_PEF,file=paste('../PrepareDataNew/',data_save_folder,'/feature_PEF_',kc,'.Rdata',sep=''))
}
```
...
foreach (kc = 1:num_files, .packages=c('tictoc', 'tidyverse', 'lubridate'))%dopar%{
  ...
  save(feature_Eosinophil,file=paste('../PrepareDataNew/',data_save_folder,'/feature_Eosinophil_',kc,'.Rdata',sep=''))
}
```
...
foreach (kc = 1:num_files, .packages=c('tictoc', 'tidyverse', 'lubridate'))%dopar%{
  ...
  feature_OCS<-f_therapy_part%>%
    ...
    select(patid,numOCS)
   rm(f_therapy_part)
   save(feature_OCS,file=paste('../PrepareDataNew/',data_save_folder,'/feature_OCS_',kc,'.Rdata',sep=''))
}
```
...
foreach (kc = 1:num_files, .packages=c('tictoc', 'tidyverse', 'lubridate'))%dopar%{
  ...
  feature_priorAsthmaEducation<-f_clinical_part%>%
   ...
   rm(f_clinical_part)
   save(feature_priorAsthmaEducation,file=paste('../PrepareDataNew/',data_save_folder,'/feature_priorAsthmaEducation',kc,'.Rdata',sep=''))
}
```
...
foreach (kc = 1:num_files, .packages=c('tictoc', 'tidyverse', 'lubridate'))%dopar%{
  ...
  feature_primarycare<-f_clinical_part%>%
    ...
    select(patid,numPCS)
   rm(f_clinical_part)
   save(feature_primarycare,file=paste('../PrepareDataNew/',data_save_folder,'/feature_primarycare',kc,'.Rdata',sep=''))
}
```
...
foreach (kc = 1:num_files, .packages=c('tictoc', 'tidyverse', 'lubridate'))%dopar%{
  ...
  feature_primarycareasthma<-f_clinical_part%>%
   ...
   rm(f_clinical_part)
   save(feature_primarycareasthma,file=paste('../PrepareDataNew/',data_save_folder,'/feature_primarycareasthma',kc,'.Rdata',sep=''))
}
```
...
foreach (kc = 1:num_files, .packages=c('tictoc', 'tidyverse', 'lubridate', 'mltools', 'data.table'))%dopar%{
 ...
 ## for the remaining features, we should get a flag next to OCS, Antibiotics, and Other Hospitalization to confirm if they are present when there 
  ...
  feature_asthmaAttacks_month <- as_tibble(one_hot(as.data.table(feature_asthmaAttacks_month)))
    ...
    #Feature 21
  save(feature_numAntibiotics,file=paste('../PrepareDataNew/',data_save_folder,'/feature_numAntibiotics_',kc,'.Rdata',sep=''))
    #Feature 22
  save(feature_acuteRespEvents,file=paste('../PrepareDataNew/',data_save_folder,'/feature_acuteRespEvents_',kc,'.Rdata',sep=''))
    #Feature 23
  save(feature_numOCS,file=paste('../PrepareDataNew/',data_save_folder,'/feature_numOCS_',kc,'.Rdata',sep=''))
    #Feature 24
  save(feature_numOCSwithLRTI,file=paste('../PrepareDataNew/',data_save_folder,'/feature_numOCSwithLRTI_',kc,'.Rdata',sep=''))
    #Feature 25
  save(feature_numAntibioticswithLRTI,file=paste('../PrepareDataNew/',data_save_folder,'/feature_numAntibioticswithLRTI_',kc,'.Rdata',sep=''))
    #Feature 26
  save(feature_numHospitals,file=paste('../PrepareDataNew/',data_save_folder,'/feature_numHospitals_',kc,'.Rdata',sep=''))
  #Feature 27
  save(feature_asthmaAttacks,file=paste('../PrepareDataNew/',data_save_folder,'/feature_asthmaAttacks_',kc,'.Rdata',sep=''))
  #Feature 27_extended
save(feature_asthmaAttacks_month,file=paste('../PrepareDataNew/',data_save_folder,'/feature_asthmaAttacksMonth_',kc,'.Rdata',sep=''))
}
```
...
# for (kc in c(1:1)){
  ...
  save(feature_comorbid,file=paste('../PrepareDataNew/',data_save_folder,'/feature_comorbid_',kc,'.Rdata',sep=''))
...
# for (kc in c(1:1)){
  ...
  save(feature_comedication,file=paste('../PrepareDataNew/',data_save_folder,'/feature_comedication_',kc,'.Rdata',sep=''))
...
foreach (kc = 1:num_files, .packages=c('tictoc', 'tidyverse', 'lubridate'))%dopar%{
 ...
 # get id of all patients
  ...
  save(asthmaAttacks_3months,file=paste('../PrepareDataNew/',data_save_folder,'/asthmaAttacks_3months_',kc,'.Rdata',sep=''))
}
toc()
```
...
foreach (kc = 1:num_files, .packages=c('tictoc', 'tidyverse', 'lubridate'))%dopar%{
 ...
 # get id of all patients
  ...
  save(asthmaAttacks_6months,file=paste('../PrepareDataNew/',data_save_folder,'/asthmaAttacks_6months_',kc,'.Rdata',sep=''))
}
```
...
foreach (kc = 1:num_files, .packages=c('tictoc', 'tidyverse', 'lubridate'))%dopar%{
 ...
 # get id of all patients
  ...
  save(asthmaAttacks_9months,file=paste('../PrepareDataNew/',data_save_folder,'/asthmaAttacks_9months_',kc,'.Rdata',sep=''))
}
```
...
foreach (kc = 1:num_files, .packages=c('tictoc', 'tidyverse', 'lubridate'))%dopar%{
 ...
 # get id of all patients
  ...
  save(asthmaAttacks_12months,file=paste('../PrepareDataNew/',data_save_folder,'/asthmaAttacks_12months_',kc,'.Rdata',sep=''))
}
```
